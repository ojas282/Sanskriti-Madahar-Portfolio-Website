  ...
  return (
    <>
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="fixed bottom-24 right-6 z-50 bg-black text-white p-4 rounded-full shadow-lg"
          ...
          >
            <div className="flex justify-between items-center p-4 border-b-2 border-black bg-yellow-300">
              ...
              <button
                ...
                className="hover:bg-yellow-400 p-2 rounded-full transition-colors"
              >
                <X size={20} />
              </button>
            </div>
              ...
              {!currentQuestion ? (
                    ...
                    {questions
                      ...
                      .map((q) => (
                        <motion.button
                          ...
                          className="w-full text-left p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-all border-l-4 border-yellow-300"
                        >
                          <div className="flex justify-between items-center">
                            <div>
                              <span className="text-sm text-gray-500 mb-1 block">{q.category}</span>
                ...
                <div className="space-y-4">
                  <motion.button
                    ...
                    className="mb-4 px-4 py-2 bg-black text-white rounded-full flex items-center gap-2"
                  >
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    {!showAnswer ? (
                      <div className="space-y-3">
                        {currentQuestion.options.map((option, index) => (
                          <motion.button
                            ...
                            className="w-full p-4 bg-gray-50 rounded-lg hover:bg-yellow-300 transition-colors text-left"
                          >
                            {option}
                          </motion.button>
                        ))}
                      ...
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="p-6 bg-yellow-300 rounded-lg"
                      >
